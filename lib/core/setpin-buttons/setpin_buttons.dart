...
class PinButtonWidget{
  final Function(String pin) onEnteredPins;
  final BuildContext context;
  final String title;
  PinButtonWidget({
    required this.onEnteredPins,
  ...
  if (pin1.text.isEmpty) {
    ...
    // context.read<SetpinButtonsCubit>().setPin1(pin.toString());
  } else if (pin2.text.isEmpty) {
    pin2.text = pin.toString();
    // context.read<SetpinButtonsCubit>().setPin2(pin.toString());
  } else if (pin3.text.isEmpty) {
    pin3.text = pin.toString();
    // context.read<SetpinButtonsCubit>().setPin3(pin.toString());
  } else {
    pin4.text = pin.toString();
    // context.read<SetpinButtonsCubit>().setPin4(pin.toString());
